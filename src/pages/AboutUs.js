        ...
        <div className="about_us_background">
            ...
            <div className='about_us_container' id='about_us_second'>
                <div className='about_us_section'>
                    ...
                    <span>Logrando qué cualquier persona tenga un inmueble digno y las empresas de construcción obtengan un mayor alcance<span className='orange_span'>.</span></span>
                </div>
            ...
            <div className='about_us_container' id='about_us_third'>
                <div className='about_us_section'>
                    ...
                    <span>Lograr qué las personas sientan <span className='orange_span'>seguridad</span> al momento de desarrollar un proyecto de construcción<span className='orange_span'>.</span></span>
                </div>
                <div className='about_us_container_img' id='about_us_second_img'>
            ...
            <div className='about_us_container' id='about_us_second'>
                <div className='about_us_section'>
                    ...
                    <span>Garantizamos la <span className='orange_span'>calidad</span> de los servicios a través de una gran supervision, capacitando a cada uno de nuestros supervisores y asesores<span className='orange_span'>.</span></span>
